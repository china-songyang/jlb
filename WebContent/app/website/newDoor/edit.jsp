...
<body>
	<div id="panel" class="easyui-panel" title="添加信息"
		...
		<form id="addForm"
			action="<%=request.getContextPath()%>/app/website/newDoor/update.action"
			method="post">
			<table>
			<tr>
			<td width="550px">
			<table class="table-form">
				<tr>
					...
					<td><input id="brand" name="brand" type="text" value="${newDoor.brand }"></input></td>
					<td><div id="brandTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right"><span style="color: red">*</span>型号:</td>
					<td><input id="model" name="model" type="text" value="${newDoor.model }"></input></td>
					<td><div id="modelTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right"><span style="color: red">*</span>价格:</td>
					<td><input id="price" name="price" type="text" value="${newDoor.price }"></input></td>
					<td><div id="priceTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right"><span style="color: red">*</span>风格:</td>
					<td><input id="mole" name="mole" type="text" value="${newDoor.mole }"></input></td>
					<td><div id="moleTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right"><span style="color: red">*</span>类型:</td>
					<td><input id="typeName" name="typeName" type="text" value="${newDoor.typeName }"></input></td>
				...
				<tr>
					...
					<td><input id="image" name="image" type="text" value="" readonly="readonly" value="${newDoor.image }"/></td>
			...
			<td>
				<img id = "imageShow" alt="" src="${newDoor.image }" width="150px"/>
				<div>
			...
			<textarea name="text" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${newDoor.text }</textarea>
			<input id="id" type="hidden" name="id" type="text" value="${newDoor.id }"></input>
